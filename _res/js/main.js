	...
	window.onload = function () {
		...
		const sections = [
			...
			{section: "General", renderSection: _ => [
				createElement(`<div class="welcome-message">Welcome to my Plugins and Themes collection Repository</div>`),
				createElement(`<div class="divider"></div>`),
				createElement(`<div class="welcome-details">Here you'll find most of the Plugins and Themes for BetterDiscord.</div>`),
				createElement(`<div class="welcome-details">This Collection is made because recently the BetterDiscord website is having problems, so you can download from here instead.</div>`),
				createElement(`<div class="divider"></div>`)]},
			{section: "Separator"},
